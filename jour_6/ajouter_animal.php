...
<body>
    <?php
        ...
        include("menu.php");
        if ($role != "admin") {
            header('Location: liste_animal.php');
        }
    ?>
    <div class="container">
        <h1>Ajouter un animal</h1>
        <form action="ajout-animal.php" method="post">
                        ...
                        <?php
                            ...
                            if ($exe2) {
                                ...
                                foreach ($resultats2 as $ligne2) {
                                    echo ('<option value="' . $ligne2["habitat_id"] . '">' . $ligne2["nom"] . '</option>');
                                }
                            } else {
                                echo "Erreur lors de l'exécution de la requête SQL";
                            }
        ...
        <button class="btn btn-primary"><a class="lien" href="liste_animal.php">Retour à la liste des animaux</a></button>
    </form>
    </div>
    <?php
        include("footer.php");
