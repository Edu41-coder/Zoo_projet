...
<body>
    ...
    <div class="container">
        ...
        <button class="btn btn-success margin2"><a class="lien" href="liste_animal.php">Retour à la liste des animaux</a></button>

        <?php
        $requete = "SELECT * 
                        FROM nourriture_animal
                        WHERE animal_id = " . $_GET['id'] .
                        " ORDER BY nourriture_animal.date DESC, nourriture_animal.heure DESC";
