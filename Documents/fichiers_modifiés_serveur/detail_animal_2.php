...
<body>
    ...
    if (!isset($_SESSION['utilisateur'])) {
        require 'vendor/autoload.php'; // charger Composer's autoloader
        ...
        if (empty($clique)) {
            ...
            // Appeler Node.js script pour update MongoDB Atlas
            shell_exec('node updateClicks.js ' . escapeshellarg($_GET['id']));
        } else {
