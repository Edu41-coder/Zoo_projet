    ...
    <div class="container">
        ...
        <div id="filtres" class="mt10perso">
            <form action="avis_animal.php" method="get">
                <input type="date" name="debut" placeholder="Date de début" value="<?php echo $debut; ?>" required>
                <input type="date" name="fin" placeholder="Date de fin" value="<?php echo $fin; ?>"  required>
