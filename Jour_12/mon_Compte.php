...
<body>
    ...
    <div class="container">
        ...
        <?php if ($role == "admin") { ?>
            ...
            $collection = $client->selectCollection('nb_cliques', 'consultationParAnimal');
            ...
            if ($animals->isDead()) {
                echo "<div>No animal consultations have been recorded yet.</div>";
            } else {
                
                echo '<div><table class="table table-striped mt10perso">';
                echo '<thead><tr><th scope="col">Animal ID</th><th scope="col">Number of Clicks</th></tr></thead>';
                echo '<tbody>';
            
                
                foreach ($animals as $animal) {
                    echo '<tr>';
                    echo '<td>' . htmlspecialchars($animal['animal_id']) . '</td>';
                    echo '<td>' . htmlspecialchars($animal['nbClique']) . '</td>';
                    echo '</tr>';
                }
