	...
	if ($exe) {
	    ...
	    foreach ($resultats as $ligne) {
	    	...
	    	<?php
	    		if ($role == "admin") { 
	    			?>
	    			<td><a href='modif_service.php?id=<?php echo($ligne["service_id"]); ?>&nom=<?php echo($ligne["nom"]); ?>&description=<?php echo($ligne["description"]); ?>' >Modifier</a></td>
			      	<td><a href='suppr_service.php?id=<?php echo($ligne["service_id"]); ?>' >Supprimer</a></td>
	    			<?php
	    		}
	    		?></tr><?php
	    }
