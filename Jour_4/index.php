...
<body>
    ...
    <div class="container" id="homePage">
        ...
        <?php
            ...
            if ($heure_actuelle >= 10 && $heure_actuelle < 19) {
                echo "Votre ZOO est actuellement <span style='color: green; font-weight: bold;'>ouvert</span> de 10h à 19h.";
            } else {
                echo "Votre ZOO est actuellement <span style='color: red; font-weight: bold;'>fermé</span>. Ouverture demain de 10h à 19h.";
            }
        ?>
        ...
        <div class='mt10perso'>
            <p>
                ...
                <br>
                <br>
                Votre ZOO est ouvert chaque jour de 10h à 19h.
            </p>
        </div>
        <div>
